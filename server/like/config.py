...
class Settings(BaseSettings):
    ...
    """
    # 上传文件路径
    upload_directory: str = '/Users/fanjunjie/Downloads/likeadmin/uploads/likeadmin-python/'
    # 上传图片限制
    ...
    # 数据源配置
    database_url: str = 'mysql+pymysql://root:123456@localhost:3306/likeadmin?charset=utf8mb4'
    # 数据库连接池最小值
